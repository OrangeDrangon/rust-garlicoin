...
impl BlockHeader {
    ...
    ///
    /// ```
    /// use garlicoin::blockdata::block::BlockHeader;
    ///
...
/// A Garlicoin block, which is a collection of transactions with an attached
/// proof of work.
...
mod tests {
    ...
    fn block_test() {
        ...
        assert_eq!(real_decode.header.difficulty(Network::Garlicoin), 1);
