...
//! Garlicoin consensus-encodable types.
//!
...
use hash_types::{BlockHash, FilterHash, FilterHeader, TxMerkleNode};
...
/// Extensions of `Write` to encode data as per Garlicoin consensus
pub trait WriteExt {
...
/// Extensions of `Read` to decode data as per Garlicoin consensus
pub trait ReadExt {
    /// Read a 64-bit uint
...
mod tests {
    ...
    use consensus::{deserialize_partial, Decodable, Encodable};
    use core::{
        fmt,
        mem::{self, discriminant},
    };
    #[cfg(feature = "std")]
    use network::{message_blockdata::Inventory, Address};
    use secp256k1::rand::{thread_rng, Rng};
    use util::endian::{u16_to_array_le, u32_to_array_le, u64_to_array_le};
