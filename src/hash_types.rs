...
hash_newtype!(
    ...
    sha256d::Hash,
    32,
    doc = "A garlicoin transaction hash/transaction ID."
);
hash_newtype!(
    Wtxid,
    sha256d::Hash,
    32,
    doc = "A garlicoin witness transaction ID."
);
hash_newtype!(
    BlockHash,
    sha256d::Hash,
    32,
    doc = "A garlicoin block hash."
);
hash_newtype!(
    SigHash,
    sha256d::Hash,
...
hash_newtype!(
    ...
    hash160::Hash,
    20,
    doc = "A hash of Garlicoin Script bytecode."
);
hash_newtype!(
    WPubkeyHash,
    hash160::Hash,
...
hash_newtype!(
    ...
    sha256::Hash,
    32,
    doc = "SegWit version of a Garlicoin Script bytecode hash."
);
...
hash_newtype!(
    ...
    sha256d::Hash,
    32,
    doc = "A hash corresponding to the witness structure commitment in the coinbase transaction"
);
hash_newtype!(
    XpubIdentifier,
    hash160::Hash,
